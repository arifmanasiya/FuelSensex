  ...
  return (
    <div style={{ maxWidth: '1040px', margin: '0 auto', padding: '1rem' }}>
      <div style={{ display: 'grid', gap: '0.75rem', placeItems: 'center', textAlign: 'center', marginBottom: '1rem' }}>
        ...
        <div style={{ fontWeight: 800, fontSize: '1.4rem' }}>About FuelTrics</div>
      ...
      <section className="card" id="about-us">
        <div className="card-header" style={{ justifyContent: 'space-between', alignItems: 'flex-start', gap: '1rem' }}>
          <div>
            <div style={{ fontWeight: 800 }}>About FuelTrics</div>
        ...
        <div className="card-body" style={{ display: 'grid', gap: '1rem' }}>
          <div style={{ display: 'grid', gap: '0.4rem', maxWidth: '78ch' }}>
            ...
            <div className="muted">
              FuelTrics was created to solve a simple but costly problem: fuel operations generate critical data,
              but operators rarely get clear answers when something goes wrong.
            </div>
          </div>

          <div className="list-card" style={{ display: 'grid', gap: '0.5rem' }}>
            <div style={{ fontWeight: 800 }}>Why we built FuelTrics</div>
            ...
            <div className="muted">
              FuelTrics exists to change that by making fuel activity visible, explainable, and defensible — while it’s still actionable.
            </div>
          </div>
          ...
          <div className="list-card" style={{ display: 'grid', gap: '0.5rem' }}>
            ...
            <div className="muted" style={{ marginTop: '0.25rem' }}>
              FuelTrics is not about replacing operators — it’s about giving them the information they need to make confident decisions.
            </div>
          </div>

          <div className="list-card" style={{ display: 'grid', gap: '0.5rem' }}>
            <div style={{ fontWeight: 800 }}>Who FuelTrics is for</div>
